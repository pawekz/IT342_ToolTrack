...
//I delete ra ning mock data later 
const mockToolItems = [
  {
    tool_id: 1,
    name: "Hammer",
                ...
                <div className="flex justify-between items-start mb-1">
                  ...
                  <div className="flex gap-1">
                    ...
                    <span className={`text-xs px-2 py-0.5 rounded-full uppercase font-semibold ${
                      ...
                      tool.status === "BORROWED" ? "bg-yellow-100 text-yellow-600" :
                      tool.status === "MAINTENANCE" ? "bg-red-100 text-red-600" :
